...
namespace DotInsideNode
{
    ...
    class SetContainer : ContainerBase
    {
        ...
        {
            if (ImGui.Button("Add Item##SetContainer"))
                m_Set.Add(NewValueTypeObject());
        }

        protected void DrawRemoveAll()
        {
            if (ImGui.Button("Remove All##SetContainer"))
                ResetSet();
        }
        ...
        {
            bool block = false;
            if (ImGui.BeginCombo("##SetContainerArrowButton" + item.ToString(), "", ImGuiComboFlags.NoPreview))
            {
